...
Options:
-e, --encoding <encoding>                Audio encoding to generate. Default: MP3. Options: MP3, LINEAR16, M4A -d, --delimiter <char>                   Delimiter to use for parsing words from a text file. "\\n" is the default.
